/**
 * Fallback list for Lucide icon autocomplete when runtime module resolution is unavailable.
 * Generated from lucide-static and kept in kebab-case for editor suggestions.
 */
const FALLBACK_LUCIDE_ICON_NAMES = [
	"a-arrow-down",
	"a-arrow-up",
	"a-large-small",
	"accessibility",
