...
This directory contains the complete internal implementation contract for the `page-teaser` directive module.

## Entry Points

- Module source: `module.ts`
- Base styles: `styles/base.scss`
- Export symbol: `pageTeaserModule`

## Contract

- The directive name is `page-teaser`.
