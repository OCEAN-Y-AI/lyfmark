...
This directory contains the complete internal implementation contract for the `background-color` directive module.

## Entry Points

- Module source: `module.ts`
- Base styles: `styles/base.scss`
- Export symbol: `backgroundColorModule`

## Contract

- The directive name is `background-color`.
