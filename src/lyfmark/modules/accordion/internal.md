...
This directory contains the complete internal implementation contract for the `accordion` directive module.

## Entry Points

- Module source: `module.ts`
- Base styles: `styles/base.scss`
- Export symbol: `accordionModule`

## Contract

- The directive name is `accordion`.
