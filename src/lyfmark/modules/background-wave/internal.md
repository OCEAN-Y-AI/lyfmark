...
This directory contains the complete internal implementation contract for the `background-wave` directive module.

## Entry Points

- Module source: `module.ts`
- Base styles: `styles/base.scss`
- Export symbol: `backgroundWaveModule`

## Contract

- The directive name is `background-wave`.
