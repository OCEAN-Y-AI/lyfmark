...
This directory contains the complete internal implementation contract for the `stacked-cards` directive module.

## Entry Points

- Module source: `module.ts`
- Base styles: `styles/base.scss`
- Export symbol: `stackedCardsModule`

## Contract

- The directive name is `stacked-cards`.
