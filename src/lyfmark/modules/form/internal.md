...
This directory contains the complete internal implementation contract for the `form` directive module.

## Entry Points

- Module source: `module.ts`
- Base styles: `styles/base.scss`
- Export symbol: `form_module`

## Contract

- The directive name is `form`.
