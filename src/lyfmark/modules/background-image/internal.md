...
This directory contains the complete internal implementation contract for the `background-image` directive module.

## Entry Points

- Module source: `module.ts`
- Base styles: `styles/base.scss`
- Export symbol: `backgroundImageModule`

## Contract

- The directive name is `background-image`.
