...
This directory contains the complete internal implementation contract for the `space` directive module.

## Entry Points

- Module source: `module.ts`
- Base styles: `styles/base.scss`
- Export symbol: `spaceModule`

## Contract

- The directive name is `space`.
