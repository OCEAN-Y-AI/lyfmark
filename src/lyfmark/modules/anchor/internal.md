...
This directory contains the complete internal implementation contract for the `anchor` directive module.

## Entry Points

- Module source: `module.ts`
- Base styles: `styles/base.scss`
- Export symbol: `anchorModule`

## Contract

- The directive name is `anchor`.
