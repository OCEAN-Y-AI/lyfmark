...
This directory contains the complete internal implementation contract for the `align` directive module.

## Entry Points

- Module source: `module.ts`
- Base styles: `styles/base.scss`
- Export symbol: `alignModule`

## Contract

- The directive name is `align`.
