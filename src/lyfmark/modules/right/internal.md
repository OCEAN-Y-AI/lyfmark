...
This directory contains the complete internal implementation contract for the `right` directive module.

## Entry Points

- Module source: `module.ts`
- Base styles: `styles/base.scss`
- Export symbol: `rightModule`

## Contract

- The directive name is `right`.
