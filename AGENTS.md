...
- Die LyfMark-`.vsix` soll über den Dateinamen relativ aus `tools/lyfmark-vscode` installiert werden, nicht über absolute Windows-Pfade, wenn der VS-Code-CLI aufgerufen wird.
